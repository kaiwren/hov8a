...
def file_processor(file_1_path, file_1_attendance_threshold_in_minutes, out_dir)
  attendees_file_path = File.join(out_dir, "attendees_#{file_1_path}")
  non_attendees_file_path = File.join(out_dir, "non_attendees_#{file_1_path}")
  unique_attendees_file_path = File.join(out_dir, "unique_attendees_#{file_1_path}")
  unique_attendees_above_attendance_threshold_file_path = File.join(out_dir, "unique_attendees_above_attendance_threshold_#{file_1_path}")
  ...
  unique_attendees_above_attendance_threshold = collated_unique_attendees.select do |attendee|
    attendee[9].to_i > file_1_attendance_threshold_in_minutes
  end
